...
type EditStringFieldProps = EditFieldProps<string>

export const EditStringField: React.FC<EditStringFieldProps> = ({
	label,
	value,
	isEdit,
	onApply,
	...
	return (
		<tr className="editor-table__field-edit">
			...
			>
				<input value={editValue} onChange={handleInputChange} onKeyDown={handleInputKeyDown} />
			</td>
